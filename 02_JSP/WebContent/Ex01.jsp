...
<body>
	...
	<%-- 
		...
		2. <%@ include %> : - 현재 페이지에 다른 문서(JSP, HTML)를 가져와서 내용을
								컴파일 할 때 사용되는 디렉티브.
								형식) <%@ include file="포함할 파일의 url경로" %>
								
							- include 지시어를 사용한 JSP 페이지가 컴 파일 되는 과정에서
	...
	<%-- 
		...
		2. 표현식 : - 일반적으로 JSP 페이지에서 자바의 System.out.println()과
				    유사하게 사용이 됨. 데이터를 출력할 때 주로 사용이 됨.
				  형식) <%= 변수명 또는 수식 %>
	...
	<%
		...
		System.out.println("su >>>> " + su); // 콘솔창에 출력이됨.
